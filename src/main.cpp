...
int64_t GetProofOfWorkReward(int64_t nFees, int nHeight)
{
    ...
    {
        nSubsidy = 111111 * COIN;
    }
    if(pindexBest->nHeight > 7 || pindexBest->nHeight <= 77 )
    {
        nSubsidy = 14 * COIN;
    }

    if(pindexBest->nHeight > 77 || pindexBest->nHeight <= 777 )
    {
        nSubsidy = 21  * COIN;
    }
    if(pindexBest->nHeight > 777 || pindexBest->nHeight <= 7777 )
    {
        nSubsidy = 28  * COIN;
    }
    if(pindexBest->nHeight > 7777 || pindexBest->nHeight <= 77777 )
    {
        nSubsidy = 21  * COIN;
    }
