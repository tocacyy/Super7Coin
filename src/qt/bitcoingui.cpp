    ...
    nWeight(0)
{
    //resize(970, 570);
	resize(1080, 662);
    setWindowTitle(tr("Super7Coin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("Super7Coin");
    setStyleSheet("#Super7Coin { background-color: #f9f9f9);  }"
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Super7Coin address"));
    ...
    masternodeManagerAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Super7CoinNodes"), this);
    masternodeManagerAction->setToolTip(tr("Show Super7CoinNodes Nodes status and configure your nodes."));
    ...
    aboutAction = new QAction(tr("&About Super7Coin"), this);
    aboutAction->setToolTip(tr("Show information about Super7Coin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Super7Coin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Super7Coin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Super7Coin client"));
...
{
    QString strTitle = tr("Super7Coin") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Super7Coin address or malformed URI parameters."));
    }
