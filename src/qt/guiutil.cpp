...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(uri.scheme() != QString("Super7Coin"))
        return false;
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("Super7Coin://"))
    {
        uri.replace(0, 12, "Super7Coin:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Super7Coin.lnk";
}
...
{
    return GetAutostartDir() / "Super7Coin.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Super7Coin-Qt") + " " + tr("version") + " " +
    ...
    setWindowTitle(tr("Super7Coin-Qt"));
