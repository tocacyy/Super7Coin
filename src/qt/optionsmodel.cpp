...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeSuper7CoinAmount"))
        settings.setValue("nAnonymizeSuper7CoinAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeSuper7CoinAmount = settings.value("nAnonymizeSuper7CoinAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeSuper7CoinAmount"))
        SoftSetArg("-anonymizeSuper7Coinamount", settings.value("nAnonymizeSuper7CoinAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeSuper7CoinAmount:
            nAnonymizeSuper7CoinAmount = value.toInt();
            settings.setValue("nAnonymizeSuper7CoinAmount", nAnonymizeSuper7CoinAmount);
            emit anonymizeSuper7CoinAmountChanged(nAnonymizeSuper7CoinAmount);
            break;
        default:
            break;
        }
