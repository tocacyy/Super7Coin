...
int nAnonymizeSuper7CoinAmount = 500;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Super7Coin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Super7Coin
    // Mac: ~/Library/Application Support/Super7Coin
    // Unix: ~/.Super7Coin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Super7Coin";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Super7Coin.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Super7Coind.pid"));
